-- ============================================================
--  nevera_court / Install/ESX_instalacija / 01_nevera_court.sql
--  ESX-safe schema — fixes MySQL #1067 Invalid default value
--  (TIMESTAMP DEFAULT NULL → DATETIME NULL DEFAULT NULL)
--  Run ONCE on ESX installation instead of sql/01_nevera_court.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `doj_cases` (
  ...
  -- Dates  (DATETIME NULL = MySQL #1067 safe on strict sql_mode)
  `incident_date`             DATE         DEFAULT NULL,
  `filed_at`                  TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
  `indictment_deadline`       DATETIME     NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `doj_bail` (
  ...
  `bail_ban_until`        DATETIME     NULL DEFAULT NULL,
